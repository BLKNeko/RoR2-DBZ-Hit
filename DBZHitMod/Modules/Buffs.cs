...
namespace HenryMod.Modules
{
    public static class Buffs
    {
        ...
        internal static BuffDef atkspeedBuff;
        ...
        internal static BuffDef AddNewSpeedBuff(string buffName, Sprite buffIcon, Color buffColor, bool canStack, bool isDebuff)
        {
            BuffDef buffDef = ScriptableObject.CreateInstance<BuffDef>();
            buffDef.name = buffName;
            buffDef.buffColor = buffColor;
        ...
        internal static BuffDef AddNewAtkSpeedBuff(string buffName, Sprite buffIcon, Color buffColor, bool canStack, bool isDebuff)
        {
            BuffDef buffDef = ScriptableObject.CreateInstance<BuffDef>();
            buffDef.name = buffName;
            buffDef.buffColor = buffColor;
