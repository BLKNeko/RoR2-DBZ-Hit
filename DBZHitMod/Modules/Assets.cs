...
namespace HenryMod.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string assetbundleName = "dbzhitassetbundle";
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("DBZHitMod." + assetbundleName))
                {
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("DBZHitMod.HenryBank.bnk"))
            {
