...
namespace HenryMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            HitPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            HitPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            HitPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
