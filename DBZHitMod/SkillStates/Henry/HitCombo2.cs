...
{
    public class HitCombo2 : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = HitCombo2.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            float dmg = HitCombo2.damageCoefficient;
            //if (this.swordController && this.swordController.swordActive) dmg = Slash.buffDamageCoefficient;

            this.attack = new OverlapAttack();
            this.attack.damageType = (Util.CheckRoll(13f, base.characterBody.master) ? DamageType.Stun1s : DamageType.Generic);
            this.attack.attacker = base.gameObject;
            this.attack.inflictor = base.gameObject;
            this.attack.teamIndex = base.GetTeam();
            this.attack.damage = dmg * this.damageStat;
            this.attack.procCoefficient = 1;
            this.attack.hitEffectPrefab = HitCombo2.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * HitCombo2.attackRecoil, -2f * HitCombo2.attackRecoil, -0.5f * HitCombo2.attackRecoil, 0.5f * HitCombo2.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, HitCombo2.hitHopVelocity);
                            }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.fixedAge >= (this.duration) && base.isAuthority && base.inputBank.skill1.down)
            {
                ...
                // if (index == 0) index = 1;
                //else index = 0;
                HitCombo3 HC3 = new HitCombo3();
                this.outer.SetNextState(HC3);
