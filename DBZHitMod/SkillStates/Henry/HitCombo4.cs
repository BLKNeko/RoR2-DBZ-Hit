...
{
    public class HitCombo4 : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = HitCombo4.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            //Chat.SendBroadcastChat(new SimpleChatMessage { baseToken = "<color=#e5eefc>{0}</color>", paramTokens = new[] { "HitCombo4" } });
            ...
            if (modelTransform)
            {
                hitBoxGroup = Array.Find<HitBoxGroup>(modelTransform.GetComponents<HitBoxGroup>(), (HitBoxGroup element) => element.groupName == "LHandHitBox");
            }
            ...
            base.PlayAnimation("Attack", "Punch2", "attackSpeed", this.duration);
            ...
            this.attack.damageType = (Util.CheckRoll(19f, base.characterBody.master) ? DamageType.Stun1s : DamageType.Generic);
            this.attack.attacker = base.gameObject;
            this.attack.inflictor = base.gameObject;
            this.attack.teamIndex = base.GetTeam();
            this.attack.damage = dmg * this.damageStat;
            this.attack.procCoefficient = 1;
            this.attack.hitEffectPrefab = HitCombo4.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * HitCombo4.attackRecoil, -2f * HitCombo4.attackRecoil, -0.5f * HitCombo4.attackRecoil, 0.5f * HitCombo4.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, HitCombo4.hitHopVelocity);
                            }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.fixedAge >= (this.duration) && base.isAuthority && base.inputBank.skill1.down)
            {
                ...
                // if (index == 0) index = 1;
                //else index = 0;
                HitCombo5 HC5 = new HitCombo5();
                this.outer.SetNextState(HC5);
